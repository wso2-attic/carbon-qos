...
<title>Update RM Global Data</title>
</head>
...
<%
    ...
    String storageManager = request.getParameter("storageManager");
    ...
    rmParameterBean.setStorageManager(storageManager);

    rmParameterBean.setConnectionString(connectionString);
    rmParameterBean.setDriverName(driverName);
    rmParameterBean.setUserName(userName);
    rmParameterBean.setPassword(password);
    ...
    try {
        stub.setParameters(rmParameterBean);
